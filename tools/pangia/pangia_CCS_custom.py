...
def parse_params(ver):
	...
	p.add_argument('-st','--sequencerType',
			...
			choices=['illumina', 'nanopore', 'pacbioCCS'],
				help="""R|You can specify either illumina, nanopore, or pacbio CCS sequencer types:\n""")
    ...
    # NEW ADDITION #
	elif args_parsed.sequencerType == 'pacbioCCS':
		if args_parsed.readmapper == 'minimap2':
			args_parsed.addOptions = "-x asm20 -s180"
			args_parsed.minScore = 0
			args_parsed.minRsnb = 1
			args_parsed.minReads = 3
